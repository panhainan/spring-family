...
<div class="body">
    ...
    <h3>项目结构</h3>
        <p>查看源码，前往GitHub，查看 <a href="https://github.com/panhainan/spring-family">github.com/panhainan/spring-family</a>下的 <b>springmvc-annotation</b>文件夹</p>
    <h3>搭建步骤</h3>
    <ul>
        <li>
        ...
        <ul>
            <li>开启@Configuration、@EnableWebMvc、@ComponentScan({"site.sixteen.demo.web"})</li>
